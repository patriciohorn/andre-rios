      ...
      <Page size="A4" style={styles.page}>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.fieldRow}>
            ...
            <Text style={styles.input}>
              {capitalize(formData.occupation)}
            </Text>
          </View>
        ...
        <View style={styles.section} break>
          ...
          <View style={styles.fieldRow}>
            ...
            <Text style={styles.input}>
              {capitalize(formData.hasIllness)}
            </Text>
          </View>
                  ...
                  {formData.allergies.map(
                    (
                      ...
                      <View
                        ...
                        style={styles.bulletItems}>
                        <Text>
                          • Allergic to: {capitalize(allergicTo)}
                        </Text>
                        <Text>
                          • Reaction: {capitalize(reaction)}
                        </Text>
                      </View>
                    )
                  )}
          ...
          <View style={styles.fieldRow}>
            ...
            <Text style={styles.input}>
              {capitalize(formData.cholesterol)}
            </Text>
          </View>
          ...
          <View style={styles.fieldRow}>
            ...
            <Text style={styles.input}>
              {capitalize(formData.orthopedic)}
            </Text>
          </View>
          ...
          <View style={styles.fieldRow}>
            ...
            <Text style={styles.input}>
              {capitalize(formData.hivPositive)}
            </Text>
          </View>
                    ...
                    {formData.surgeries.map(
                      (
                        ...
                        <View
                          ...
                          style={styles.bulletItems}>
                          <Text>
                            • Surgery Name: {capitalize(surgeryName)}
                          </Text>
                          <Text>
                            • Surgery Year: {capitalize(surgeryYear)}
                          </Text>
                          <Text>
                            • Surgery Reason:{' '}
                            {capitalize(surgeryReason)}
                          </Text>
                        </View>
                      )
                    )}
